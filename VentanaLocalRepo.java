 ...
 * @author nico4
 */
public class VentanaLocalRepo extends javax.swing.JFrame {

    /**
     * Creates new form VentanaLocalRepo
     */
    public VentanaLocalRepo() {
        initComponents();
        setDefaultCloseOperation(NueArcVent.DISPOSE_ON_CLOSE);
        
        int largo = VariablesGlobales.repo.local.listaCommits.size();
        ...
        if (VariablesGlobales.repo.local.listaCommits.size() == 1){
            lst2.setVisible(false);
            lst3.setVisible(false);
            ...
            List<TextoArchivo> listarArchivos = VariablesGlobales.repo.local.listaCommits.get(largo - 1).getArchivos();

            txt1.setText("El autor del ultimo commit creado es " + VariablesGlobales.repo.local.listaCommits.get(largo - 1).datoGet(VariablesGlobales.repo.local.listaCommits.get(largo - 1), "autor"));
            txt2.setText(" con el comentario " + VariablesGlobales.repo.local.listaCommits.get(largo - 1).datoGet(VariablesGlobales.repo.local.listaCommits.get(largo - 1), "comentario"));
        ...
        if (VariablesGlobales.repo.local.listaCommits.size() == 2){
            lst3.setVisible(false);
            ...
            listarArchivos = VariablesGlobales.repo.local.listaCommits.get(largo - 2).getArchivos();

            txt3.setText("El autor del ultimo commit creado es " + VariablesGlobales.repo.local.listaCommits.get(largo - 2).datoGet(VariablesGlobales.repo.local.listaCommits.get(largo - 2), "autor"));
            txt4.setText(" con el comentario " + VariablesGlobales.repo.local.listaCommits.get(largo - 2).datoGet(VariablesGlobales.repo.local.listaCommits.get(largo - 2), "comentario"));
        ...
        if (VariablesGlobales.repo.local.listaCommits.size() > 2){
            ...
            listarArchivos = VariablesGlobales.repo.local.listaCommits.get(largo - 3).getArchivos();

            txt5.setText("El autor del ultimo commit creado es " + VariablesGlobales.repo.local.listaCommits.get(largo - 3).datoGet(VariablesGlobales.repo.local.listaCommits.get(largo - 3), "autor"));
            txt6.setText(" con el comentario " + VariablesGlobales.repo.local.listaCommits.get(largo - 3).datoGet(VariablesGlobales.repo.local.listaCommits.get(largo - 3), "comentario"));
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(txt3, javax.swing.GroupLayout.DEFAULT_SIZE, 234, Short.MAX_VALUE)
                            ...
                            .addComponent(txt1, javax.swing.GroupLayout.DEFAULT_SIZE, 234, Short.MAX_VALUE)
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VentanaLocalRepo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VentanaLocalRepo().setVisible(true);
            }
        });
    }
